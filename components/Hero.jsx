        ...
        <div className="container mx-auto">
            <div className="flex justify-between gap-x-8">
                ...
                <div className="flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
                    ...
                    <h1 className="h1 mb-4">Hello, my name is Irakli Beridze</h1>
                 ...
                 <div className="hidden xl:flex relative">
                    {/* badge 1*/}
                    <Badge icon={<RiBriefcase4Fill/>} endCountNum={3} badgeText='Years Of Experience' containerStyles='absolute top-[24%] -left-[5rem]'/>
                    {/* badge 2*/}
                    <Badge icon={<RiTodoFill/>} endCountNum={6} endCountText='k' badgeText='Finished Projects' containerStyles='absolute top-[80%] -left-[1rem]'/>
                     {/* badge 3*/}
                     <Badge icon={<RiTeamFill/>} endCountNum={9} endCountText='k' badgeText='Happy Clients' containerStyles='absolute top-[55%] -right-8'/>
